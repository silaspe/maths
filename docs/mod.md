...
Say goodbye to the modular arithmetic page and say hello to a new page, It's name is the name of the first chapter on the [brainstorm page](https://silaspe.github.io/maths/aa.html) without a question mark... Or just scroll down the dropdown menu or home page.
