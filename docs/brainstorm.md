...
$$ \text{"For any variabe (call it } x_1 \text{), } x_1 \in 2 \text{ implies that it is } 1 \text{, that is, for any variabe (call it } x_2 \text{), } x_2 \in 1 \text{ implies that it is } 0 \text{, that is, there is not an } x_3 \in x_2 \text{"} $$
