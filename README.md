...
* [Lambda calculus revisited](lcr.md) - (Lcr) I gave up on this one, but then I came back! You can stil watch [this](https://www.youtube.com/watch?v=3VQ382QG-y4) and [this](https://www.youtube.com/watch?v=pAnLQ9jwN-E), and read [this](https://arxiv.org/pdf/0804.3434) (Warning: the videos are ~ $1 \text{H}$ long, and the paper has (exactly) $120$ pages).
