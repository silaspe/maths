...
* [Lambda calculus revisited](lcr.md) - (Lcr) I gave up on this one, but then I came back! It is still heavally based off of [this](https://www.youtube.com/watch?v=3VQ382QG-y4), [this](https://www.youtube.com/watch?v=pAnLQ9jwN-E), and even more heavally based off of [this](https://arxiv.org/pdf/0804.3434) (Warning: the videos are ~ $1 \text{H}$ long, and the paper has (exactly) $120$ pages).
* [Linear algebra](linear.md) - A course about the more general mathmetician's version of linear algebra, the study of vectors (like the strange man with a bowlcut and an orange suit) and matracies (like the fake AI generated simulated reality). But if you want some more intuition about how it works, each chapter will have a corrasponding part in [this playlist](https://www.youtube.com/playlist?list=PLZHQObOWTQDPD3MizzM2xVFitgF8hE_ab)
